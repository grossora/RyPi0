 ...
 * \ingroup Pi0Ana
 * 
 * \brief Class def header for a class MCTopo
 *
 * @author ryan
 */
...
#ifndef LARLITE_MCTOPO_H
#define LARLITE_MCTOPO_H
...
namespace larlite {
   ...
   */
  class MCTopo : public ana_base{
  
  public:

    /// Default constructor
    MCTopo(){ _name="MCTopo"; _fout=0;_bothccnc=false; _ccnc=1; _sig = true;  _topo=2; _fid=0.0; _showerenergy=0; _showerdetenergy=0; _showercontain=0;}

    /// Default destructor
    virtual ~MCTopo(){}

    /** IMPLEMENT in MCTopo.cc!
